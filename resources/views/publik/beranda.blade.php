...
@section('konten')
        ...
        <div class="relative bg-[#353535] bg-cover bg-center" style="background-image: linear-gradient(rgba(53,53,53,.7), rgba(53,53,53,.7)), url('{{ Storage::url('profil/desa-poto.jpg') }}'); background-blend-mode: normal;">
            <div class="mx-auto max-w-7xl px-4 lg:px-5 py-20 lg:py-36">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl text-white font-heading font-black leading-tight mb-5">Sistem Informasi <span style="color: #AB7442;">Adat</span> Desa Poto</h1>
             
                    <div class="flex flex-wrap justify-center gap-3">
                        <a href="{{ route('informasi.index') }}" class="btn-primary py-3.5 px-7 text-sm font-medium uppercase">Jelajahi Informasi Adat <svg class="h-4 w-4 ms-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg></a>
                        <a href="{{ route('profil') }}" class="btn-woody-light py-3.5 px-7 text-sm font-medium uppercase">Tentang Kota</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-[#F5F5F5] overflow-hidden my-16">
        <div class="max-w-7xl mx-auto px-4 lg:px-5 py-16 flex items-center justify-center">
            <div class="w-full max-w-3xl">
                <div class="section-title text-center">
                    <h1 class="text-4xl sm:text-[42px] font-heading font-black text-stone-700 mb-4">Tentang Kami</h1>
                </div>
                <p class="text-stone-600 font-sans leading-relaxed mb-6 text-center">Sistem Informasi Adat Desa Poto adalah platform digital yang bertujuan untuk mendokumentasikan, melestarikan, dan menyebarluaskan informasi mengenai adat istiadat serta budaya yang ada di Desa Poto, Kecamatan Moyo Hilir, Kabupaten Sumbawa.</p>
    ...
    <div class="bg-[#F5F5F5] overflow-hidden my-12 lg:my-16">
        <div class="max-w-7xl mx-auto px-4 lg:px-5 py-10 lg:py-16 flex flex-col items-center">
            <div class="section-title text-center">
                <h1 class="text-4xl sm:text-[42px] font-heading font-black text-stone-700 mb-8">Kegiatan Adat</h1>
            </div>
            @if ($kegiatanTerbaru->isEmpty())
                <p class="text-center text-stone-500">Belum ada kegiatan adat yang dijadwalkan.</p>
            @else
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 w-full max-w-6xl">
                ...
                <div class="text-center mt-8">
                    <a href="{{ route('kegiatan.index') }}" class="btn-woody py-3.5 px-7 text-sm font-medium uppercase">Lihat Semua <svg class="h-4 w-4 ms-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg></a>
                </div>
            @endif
        </div>
    </div>
