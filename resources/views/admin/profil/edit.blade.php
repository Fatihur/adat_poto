...
@section('judul', 'Edit Profil Desa')

@section('konten')
    <nav class="flex items-center gap-2 text-sm text-stone-500 mb-4">
        <a href="{{ route('admin.profil.index') }}" class="hover:text-amber-800 transition">Profil Desa</a>
        <span class="text-stone-300">/</span>
        <span class="text-stone-800 font-medium">Edit</span>
    </nav>

    <div class="max-w-3xl">
        <form method="POST" action="{{ route('admin.profil.update', $profil) }}" enctype="multipart/form-data"
